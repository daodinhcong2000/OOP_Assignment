...
public final class GameEntities {
	...
	private static final Set<Pair<Class<? extends EffectEntity>, Class<? extends LivingEntity>>> EFFECT_LIVING_SET
			...
			Pair.immutableOf(SuperBullet.class, NormalEnemy.class),
			...
			Pair.immutableOf(SuperBullet.class, SmallerEnemy.class),
			...
			Pair.immutableOf(SuperBullet.class, TankerEnemy.class),
			...
			Pair.immutableOf(SuperBullet.class, BossEnemy.class),
